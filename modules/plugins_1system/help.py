...
async def helps(client, message):
    try:
        ...
        da = await client.send_photo(message.chat.id, "photos/logo_banner.png", caption="Loading the help menu. Please, wait...", message_thread_id=message.message_thread_id)
